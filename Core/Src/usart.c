...
/**
 * @brief Redirects the standard output (stdout) to the USART1.
 * @param ch Character to be printed.
 * @param fp File pointer (not used).
...
/**
 * @brief Redirects the standard input (stdin) to the USART1.
 * @param fp File pointer (not used).
...
/* USER CODE BEGIN Header_Uasrt3_Task */
/**
* @brief Function implementing the USART3_TASK thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Uasrt3_Task */
void Uasrt3_Task(void const * argument)
{
    /* USER CODE BEGIN Uasrt3_Task */
    /* Infinite loop */
    for(;;)
    {
        osDelay(1000);
    }
    /* USER CODE END Uasrt3_Task */
}
